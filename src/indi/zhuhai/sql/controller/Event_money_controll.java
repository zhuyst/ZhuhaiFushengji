...
import indi.zhuhai.sql.data.Event_money_data;
...
public class Event_money_controll{
	...
	//激活关于意外得财/失财的事件，如果符合条件则激活并返回true，不符合则返回false
	public boolean active (String player_name,int event_ID){	
